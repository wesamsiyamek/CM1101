...
def normalise_input(user_input):
    ...
    'help'
    """
    newtext = remove_spaces(user_input)
    
    newtext = remove_punct(user_input)
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        newname = normalise_input(user_input)

        if is_valid_exit(exits, newname):
            break
            
        else:
            print("You cannot go this way, please try again.")
...
def main():
    ...
    #exit_leads_to(rooms["Tutor"]["exits"], "west")
    #is_valid_exit(rooms["Parking"]["exits"], "east")
    #print(is_valid_exit(rooms["Reception"]["exits"], "east"))
